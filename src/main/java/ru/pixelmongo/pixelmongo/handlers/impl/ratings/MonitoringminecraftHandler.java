...
@Component("ratingMonitoringminecraft")
public class MonitoringminecraftHandler implements RatingHandler{

    @Value("${ratings.top.monitoringminecraft.enabled}")
    private boolean enabled;

    @Value("${ratings.top.monitoringminecraft.secret_key}")
    private String key;
